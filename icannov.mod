...
: Taken from Cholinergic Modulation Shifts the Response of CA1 Pyramidal Cells to Depolarizing Ramps via TRPM4 
: Channels with Potential Implications for Place Cell Firing (Combe et al., 2023)
: to account for slow calcium-activated cation current
