...
Test file for tuning parameters to fit constraints from Kim and Hsu et al., 2015
...
PARAMETER {
    ...
    P0 = 0.300          (1)     < 0, 1 >        : basal release probability
    f = 0.490           (1)     < 0, 1e9 >      : additive facilitation per spike
    tau_F = 272.772    (ms)    < 1e-9, 1e9 >   : rate of decay back to baseline following facilitation
    d1 = 0.922       (1)     < 0, 1 >        : multiplicative fast depression per spike
    tau_D1 = 139.377  (ms)    < 1e-9, 1e9 >   : rate of decay back to baseline following fast depression
