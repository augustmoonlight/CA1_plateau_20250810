...
:
: References:  https://doi.org/10.7554/eLife.84387
: Incorporated for slowly growing membrane potential under cholinergic modulation in Han-Ying's experiments and Takahashi & Magee (2009)
: Incorporated to this project since 2024/10/30
: Current usage: cal4 (the Ca2+-holding mechanisms in the aforementioned literature) was not used for practical concerns
: (take 3x times to run and more difficult to tune),
: so we now use the more common cacumm mechanism as the Ca2+-holding mechanisms in the model. 
:
...
ASSIGNED {
	jip3p (mM/ms) :doesn't seem to serve specific purposes in this version of .mod file and associated usages
    ican (mA/cm2)
    drive_channel (mM/ms)
    itrpm4 (mA/cm2)
    Po_inf
